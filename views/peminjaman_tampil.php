            ...
            <div class="panel panel-success">
                ...
                <div class="panel-body">
                    <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                <th>No.</th><th>Kode Buku</th><th>Nama Peminjam</th><th>Tanggal Pinjam</th><th>Tanggal Kembali</th><th>Lama Pinjaman</th><th>ACTIONS</th>
                            </tr>
                        </thead>
                        <tbody>
                  ...
                  <td><?= $data['tgl_kembali'] ?> &nbsp <a href="?page=peminjaman&actions=kembaliArsip&nope=<?= $data['no_perkara'] ?>" class="">
                                            </a>
                                    </td>
