                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" action="" method="post">
                        <div class="form-group">
                            <label for="nope" class="col-sm-3 control-label">Kode Buku</label>
                             <div class="col-sm-9">
								<input type="text" name="nope" value="<?=$data['kd_buku']?>"class="form-control" id="inputEmail3" placeholder="Kode Buku" readonly="true">
                            </div>
                        </div>
                        <div class="form-group">
...
if($_POST){
    ...
    $ket=$_POST['ket'];
    //buat sql
    $sql="UPDATE peminjaman SET kd_buku = '$nope', peminjam='$peminjam', tgl_pinjam='$tglPinjam', tgl_kembali='$tglKembali', lama_pinjam='$lamapinjam' WHERE id='$id'"; 
