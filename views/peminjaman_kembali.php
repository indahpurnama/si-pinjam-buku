<?php
$kode=$_GET['kd_buku'];
$ambil=  mysqli_query($koneksi, "SELECT * FROM peminjaman WHERE kd_buku ='$kode'") or die ("SQL Edit error");
                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" action="" method="post">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
								<input type="text" name="kd_buku" value="<?=$data['kd_buku']?>" class="form-control" id="inputEmail3" placeholder="Kode Buku" readonly="true">
                            </div>
                        </div>
...
if($_POST){
    ...
    //buat sql
    $sql="UPDATE peminjaman SET tgl_kembali='$tglKembali', lama_pinjam='$lamapinjam' WHERE kd_buku='$kode'";
	$sqlArsip="UPDATE buku SET status='Ada' WHERE kd_buku='$kode'";
